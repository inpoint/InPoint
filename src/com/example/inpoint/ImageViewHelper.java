...
//		center();
	...
	*	if the figure is bigger than screen, 
	*   then (screen_width/screen_height) / (figure_width/figure_height) < 1 and then zoom in the figure  
	*
	*	vice versa
	*/
	public void minZoom() {
    ...
    //reset the figure to the screen center once it go over the display boundary
